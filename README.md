...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/clean-text-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11687&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/clean-text-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `clean-text` can be installed with:

```
conda install clean-text
```

It is possible to list all of the versions of `clean-text` available on your platform with:
